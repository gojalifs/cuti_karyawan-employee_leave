            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="ml-4 mt-3">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Buat Permohonan
                                Cuti</button>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="formModal">Form Pengajuan Cuti Karyawan</h5>
                                ...
                                <select name="jenis" id="jenis" class="form-control">
                                    @foreach ($jenis_cuti as $cuti)
                                        <option value="{{ $cuti->id }}">
                                            {{ $cuti->nama_cuti }} (Sisa {{ $cuti->sisa }} {{ $cuti->satuan }})
                                        </option>
                                    @endforeach
                                </select>
                            </div>
