                        ...
                        <div class="card l-bg-cyan-dark">
                            <div class="card-statistic-3">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Sisa Cuti {{ $item->nama_cuti }}</h4>
                                    <span>{{ $item->sisa }} hari</span>
                        ...
                        <div class="card-statistic-3">
                            ...
                            <div class="card-content">
                                ...
                                <p class="mb-0 text-sm">
                                    ...
                                    <a href="{{ route('karyawan.permohonan.disetujui') }}" class="text-white">View
                                        Detail</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('karyawan.permohonan') }}" class="btn btn-info"> <i class="fa fa-eye"></i>
                                    View All</a>
                            </div>
                        </div>
                        <div class="card-body">
